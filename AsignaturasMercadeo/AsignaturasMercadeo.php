<?php
// URL de la API
$apiUrl = "https://api-ucne-emfugwekcfefc3ef.eastus-01.azurewebsites.net/api/Asignaturas?CarreraId=10";
...
$carreraIdBuscado = 10; // ID específico para Sistemas
?>
...
<head>
    ...
    <title>Asignaturas Mercadeo</title>
    <link rel="stylesheet" href="AsignaturasMercadeo.css">
</head>
<body>
    <div class="container">
        <header>
