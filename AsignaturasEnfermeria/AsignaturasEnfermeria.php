<?php
// URL de la API
$apiUrl = "https://api-ucne-emfugwekcfefc3ef.eastus-01.azurewebsites.net/api/Asignaturas?CarreraId=8";
...
$carreraIdBuscado = 8; // ID específico para Sistemas
?>
...
<head>
    ...
    <title>Asignaturas Enfermeria</title>
    <link rel="stylesheet" href="AsignaturasEnfermeria.css">
</head>
<body>
    <div class="container">
        <header>
