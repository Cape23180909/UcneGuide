<?php
// URL de la API
$apiUrl = "https://api-ucne-emfugwekcfefc3ef.eastus-01.azurewebsites.net/api/Asignaturas?CarreraId=6";
...
$carreraIdBuscado = 6; // ID específico para Sistemas
?>
...
<head>
    ...
    <title>Asignaturas Medicina</title>
    <link rel="stylesheet" href="AsignaturasMedicina.css">
</head>
<body>
    <div class="container">
        <header>
