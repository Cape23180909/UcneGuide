<?php
// URL de la API
$apiUrl = "https://api-ucne-emfugwekcfefc3ef.eastus-01.azurewebsites.net/api/Asignaturas?CarreraId=12";
...
$carreraIdBuscado = 12; // ID específico para Sistemas
?>
...
<head>
    ...
    <title>Asignaturas Arquitectura</title>
    <link rel="stylesheet" href="AsignaturasArquitectura.css">
</head>
<body>
    <div class="container">
        <header>
