<?php
// URL de la API
$apiUrl = "https://api-ucne-emfugwekcfefc3ef.eastus-01.azurewebsites.net/api/Asignaturas?CarreraId=4";
...
<head>
    ...
    <title>Asignaturas Administracion de Emppresas</title>
    <link rel="stylesheet" href="AsignaturasAdminEmpresa.css">
</head>
<body>
    <div class="container">
        <header>
